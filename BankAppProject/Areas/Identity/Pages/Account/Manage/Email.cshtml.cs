...
namespace BankAppProject.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                // Uppdatera användarnamnet också, om du använder email som username
                ...
                StatusMessage = "Email address changed successfully.";
